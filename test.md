...
This sample offers you an option by which you can choose to create a WebLogic domain with no leasing or to create a WebLogic domain with database leasing. If you want to try service migration based with this domain, you need to create a WebLogic domain with database leasing.
