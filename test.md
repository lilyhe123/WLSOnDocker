...
This sample offers you an option by which you can choose to create a WebLogic domain with no leasing or to create a WebLogic domain with database leasing.
